...
[cols="25,33,37"]
|===
| Sicherungsdatei 2+| Zielarbeitsumgebung 


| *Lage* | *Volume Restore* | *Ordner- und Dateiwiederherstellung* ifdef::aws[] 
...
+
Sie können auch die preisgünstigere Storage-Klasse _Nearline_ oder die Speicherklassen _Coldline_ oder _Archive_ verwenden. Sie konfigurieren diese anderen Speicherklassen über Google. Siehe das Thema Google link:https://cloud.google.com/storage/docs/storage-classes["Speicherklassen"^] Finden Sie Informationen zum Ändern der Speicherklasse.
